...
class AsyncGoosefs:
    ...
    def rename(self, src: str, dst: str, *, persist: bool | None = ...) -> Awaitable[None]: ...
    def persist(self, path: str, *, persistence_wait_time: int | None = ...) -> Awaitable[None]: ...
    def set_attribute(
        self,
        path: str,
        *,
        ...
        write_type: WriteType | None = ...,
        direct_children_load: bool | None = ...,
    ) -> Awaitable[None]: ...
...
class Goosefs:
    ...
    def rename(self, src: str, dst: str, *, persist: bool | None = ...) -> None: ...
    def persist(self, path: str, *, persistence_wait_time: int | None = ...) -> None: ...
    def set_attribute(
        self,
        path: str,
        *,
