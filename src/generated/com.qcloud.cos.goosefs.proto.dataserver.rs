...
pub struct OpenUfsBlockOptions {
    ...
    /// Total file length. When set (> 0), the worker uses withFileStatus() to skip
    /// an extra HEAD request when opening the UFS stream.
    #[prost(int64, optional, tag = "9")]
    pub file_length: ::core::option::Option<i64>,
}
